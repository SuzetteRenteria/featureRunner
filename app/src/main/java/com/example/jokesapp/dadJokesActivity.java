    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_j1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                tv_JokeDisplay.setText(R.string.j1);
            }
        });

        //button Joke 1 Answer
        btn_j1_ans.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tv_JokeDisplay.setText(R.string.j1_ANS);
            }
        });
        ...
        btn_j2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tv_JokeDisplay.setText(R.string.j2);
            }
        });

        //button Joke 2 Answer
        btn_j2_ans.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tv_JokeDisplay.setText(R.string.j2_ANS);
            }
        });
    }
}