...
public class NumeralConverterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dec_to_rom_BTN.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        rom_to_dec_BTN.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new Thread(new Runnable() {
                    @Override
